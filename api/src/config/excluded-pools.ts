/**
 * List of pool addresses to exclude from CoinGecko endpoints
 * These are deprecated or test pools that should not be reported
 */
export const EXCLUDED_POOLS = new Set([
