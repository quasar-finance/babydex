...
export class AstroportNativeCoinRegistryQueryClient
  implements AstroportNativeCoinRegistryReadOnlyInterface
{
...
export interface AstroportNativeCoinRegistryInterface
  extends AstroportNativeCoinRegistryReadOnlyInterface {
  contractAddress: string;
  sender: string;
  add: (
    {
...
export class AstroportNativeCoinRegistryClient
  extends AstroportNativeCoinRegistryQueryClient
  implements AstroportNativeCoinRegistryInterface
{
