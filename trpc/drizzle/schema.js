import { pgTable, pgSchema, index, foreignKey, integer, text, bigint, jsonb, timestamp, smallint, numeric, doublePrecision, json } from "drizzle-orm/pg-core";
...
export const historicPoolYieldInV1Cosmos = v1Cosmos.view("historic_pool_yield", {
